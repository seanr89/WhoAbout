...
const ProfileScreen: React.FC<ProfileScreenProps> = ({ currentUser, onUpdateUser }) => {
  ...
  const getRoleBadgeColor = (role: Role) => {
    switch (role) {
      ...
      default:
        return 'bg-slate-100 text-slate-800'; // Employee
    }
  };
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        <div className="md:flex">
          <div className="md:flex-shrink-0 bg-indigo-600 md:w-48 flex flex-col items-center justify-center p-8">
            ...
            <div
              className={`px-3 py-1 rounded-full text-xs font-semibold ${getRoleBadgeColor(currentUser.role)} bg-opacity-90`}
            >
            ...
            <div className="space-y-6">
              <div>
                ...
                {isEditing ? (
                  ...
                  <p className="text-slate-900 border-b border-slate-100 pb-2">
                    {currentUser.name}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="flex items-center">
                  <span
                    className={`w-2 h-2 rounded-full mr-2 ${currentUser.isActive ? 'bg-green-500' : 'bg-red-500'}`}
                  ></span>
